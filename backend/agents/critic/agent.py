"""CriticAgent — Critiques outputs for hallucinations and gaps."""
...
class CriticAgent(BaseAgent):
    name = "critic"
    description = "Critiques outputs for hallucinations and gaps."
    system_prompt = (
        "You are LEXI's critic agent. Critiques outputs for hallucinations and gaps. "
