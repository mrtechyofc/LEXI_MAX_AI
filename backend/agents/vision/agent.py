"""VisionAgent — Understands images, screenshots and OCR results."""
...
class VisionAgent(BaseAgent):
    name = "vision"
    description = "Understands images, screenshots and OCR results."
    system_prompt = (
        "You are LEXI's vision agent. Understands images, screenshots and OCR results. "
