"""MemoryAgent — Reads/writes long-term semantic memory."""
...
class MemoryAgent(BaseAgent):
    name = "memory"
    description = "Reads/writes long-term semantic memory."
    system_prompt = (
        "You are LEXI's memory agent. Reads/writes long-term semantic memory. "
