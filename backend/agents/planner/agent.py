"""PlannerAgent — Breaks high-level goals into concrete subtasks."""
...
class PlannerAgent(BaseAgent):
    name = "planner"
    description = "Breaks high-level goals into concrete subtasks."
    system_prompt = (
        "You are LEXI's planner agent. Breaks high-level goals into concrete subtasks. "
